...
key_zones = {
    "C4": [(572, 268), (611, 268), (618, 307), (601, 307)],
    ...
    "G5": [(135, 268), (175, 268), (165, 307), (115, 307)],
...
def is_inside_zone(point, zone):
    """ Kiểm tra xem điểm có nằm trong vùng phím không """
...
def generate_frames():
    ...
    while True:
        ...
        finger_ids = [8, 12, 16, 20]  # Ngón trỏ, giữa, áp út, út
                ...
                for id in finger_ids:
                    ...
                    for key, zone in key_zones.items():
                        if is_inside_zone((cx, cy), zone):
                            ...
                            if key not in previous_pressed_keys and key in sounds:
                                sounds[key].play()
                            break
